...
// in simulator we redefine to format for SimQlePad Developer console
...
{\
	NSString * exceptionName = [@"org.simqlepad." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.simqlepad";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UISimQlePadNativeItemNone = -1, 
	UISimQlePadNativeItemSpinner = -2,
	UISimQlePadNativeItemProgressBar = -3,
	
	UISimQlePadNativeItemSlider = -4,
	UISimQlePadNativeItemSwitch = -5,
	UISimQlePadNativeItemMultiButton = -6,
	UISimQlePadNativeItemSegmented = -7,
	
	UISimQlePadNativeItemTextView = -8,
	UISimQlePadNativeItemTextField = -9,
	UISimQlePadNativeItemSearchBar = -10,
	
	UISimQlePadNativeItemPicker = -11,
	UISimQlePadNativeItemDatePicker = -12,
	
	UISimQlePadNativeItemInfoLight = -13,
	UISimQlePadNativeItemInfoDark = -14,
	
	UISimQlePadNativeItemDisclosure = -15,
	
	UISimQlePadNativeItemContactAdd = -16
};
