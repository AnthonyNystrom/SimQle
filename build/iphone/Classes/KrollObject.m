...
//@interface SimQlePadObject : NSObject
//@end

@interface SimQlePadObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[SimQlePadObject class]])
		{
			for (NSString *key in [[(SimQlePadObject*)o modules] allKeys])
			{
